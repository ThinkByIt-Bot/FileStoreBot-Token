...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", This video/Photo/anything is available on internet.  We @LeakHubd or it Subsidiary channel doesn't produce any of them)
